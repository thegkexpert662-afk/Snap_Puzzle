...
class _HomeScreenState extends State<HomeScreen>
  ...
  Widget _buildChampionCard() {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(stream: FirebaseFirestore.instance.collection('leaderboard').orderBy('score', descending: true).limit(1).snapshots(), builder: (context, snapshot) {
