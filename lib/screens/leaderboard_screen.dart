            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      data['name']?.toString() ?? 'Unknown Player',
                      maxLines: 1,
...
class _ComingSoonCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          colors: [Color(0xFF262A9C), Color(0xFF092C76)],
        ),
        borderRadius: BorderRadius.circular(28),
        border: Border.all(
          color: const Color(0xFF4539D4),
          width: 2,
        ),
        boxShadow: const [
          BoxShadow(
            color: Color(0x553D35FF),
            blurRadius: 16,
          ),
        ],
      ),
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 6),
                Text(
                  'New challenges and rewards are on the way!',
                  style: TextStyle(
        ...
        child: Stack(
          children: [
            Positioned(
              top: 100,
              left: -100,
              child: _glow(230, const Color(0xFF005DFF)),
            ),
            Positioned(
              top: 420,
              right: -120,
              child: _glow(260, const Color(0xFF0055B9)),
            ),
            Positioned(
              bottom: 80,
              left: 30,
              child: _glow(210, const Color(0xFF1623A7)),
            ),
          ],
        ),
      ),
